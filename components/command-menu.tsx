        ...
        const down = (e: KeyboardEvent) => {
            ...
            if (e.shiftKey) {
                ...
                // Links
                    ...
                    e.preventDefault()
                    runCommand(() => window.open("https://x.com/Paarth_h", "_blank"))
                } else if (key === 'l') {
                    e.preventDefault()
                    runCommand(() => window.open("https://linkedin.com/in/partha-dash-0500b2323", "_blank"))
                } else if (key === 'g') {
                    e.preventDefault()
                    runCommand(() => window.open("https://github.com/Partha-png", "_blank"))
                } else if (key === 'e') {
                    e.preventDefault()
            ...
            <CommandDialog open={open} onOpenChange={setOpen} className="font-custom2">
                ...
                <CommandList className="font-custom2 p-2">
                    ...
                    <CommandGroup heading="Links">
                        <CommandItem onSelect={() => runCommand(() => window.open("https://x.com/Paarth_h", "_blank"))} className="rounded-lg py-3">
                        ...
                        <CommandItem onSelect={() => runCommand(() => window.open("https://linkedin.com/in/partha-dash-0500b2323", "_blank"))} className="rounded-lg py-3">
                        ...
                        <CommandItem onSelect={() => runCommand(() => window.open("https://github.com/Partha-png", "_blank"))} className="rounded-lg py-3">
