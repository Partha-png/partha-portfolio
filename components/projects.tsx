...
const Projects = ({ showAll = false }: { showAll?: boolean }) => {
  ...
  const projects: Project[] = [

    {
      ...
      video: "",
      description: "An AI-powered code cleaning bot for GitHub",
      tech: ["python", "fastapi", "langchain"],
      github: "https://github.com/Partha-png/auto_Refractor",
      live: "web-production-27db6.up.railway.app",
    },
    {
      title: "Small-Language-Model from scratch",
      src: "/slm_loss_curves.png",
      video: "/scribble.mp4",
      description: "Small-Language-Model",
      tech: ["python", "pytorch", "streamlit"],
      github: "https://github.com/Partha-png/slm-model",
      live: "",
    },
    {
      title: "Fkleetcode",
      src: "/fkleetcode_preview.png",
      video: "/inquiro.mp4",
      description: "AI Assited interview helper(building...)",
      tech: ["next", "python", "langchain"],
      github: "https://github.com/Partha-png/fkleetcode",
      live: " ",
    },
    {
      title: "Stock price predictor ",
      src: "/stock_predictor_preview.png",
      video: "/scribble.mp4",
      description: "Stock price predictor using bilstm-mtran-tcnb",
      tech: ["python", "pytorch"],
      github: "https://colab.research.google.com/drive/1vFceCJR8lIdsv4Llo1x16XZNT-va_dsy",
      live: " ",
    },
  ...
  return (
    <div className="mt-8">
      ...
      <p
        ...
        "
      >
        stuff i've built (may contain bugs, probably contains coffee)
      </p>
