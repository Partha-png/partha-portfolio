    ...
    const fetchPRs = async () => {
      try {
        const searchQuery = filterType === "merged"
          ? "author:Partha-png type:pr is:merged"
          : filterType === "open"
            ? "author:Partha-png type:pr is:open"
            : "author:Partha-png type:pr is:closed is:unmerged";
  ...
  return (
    <div>
      ...
      <p className=" font-custom2 text-neutral-700 dark:text-neutral-300 mt-3 px-4 py-[7px]
          ...
          bg-neutral-100 dark:bg-neutral-900 border-dashed border-neutral-300 dark:border-neutral-700 border mb-6">me pretending to be productive on github</p>
